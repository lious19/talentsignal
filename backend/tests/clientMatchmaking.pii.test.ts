 ...
 * appear here, for ANY role, unlike GET /candidates which shows it to
 * admin/recruiter (06_decisions/009). This locks that contract in with a
 * test rather than trusting the field list alone.
 */
