...
| 047 | Hard-to-fill reweight for capacitySignal (roleScarcity 0.6→0.48, daysOpen/repostedRole 0.2→0.16 each, capacitySignal 0.20) — dilutes S-23's "roleScarcity is dominant" framing, proposal drafted, awaiting Ali | S-24 | **hard — ask Ali** |
